...
public class FlatscreenTVCpuBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:flatscreen_tv_cpu")
	public static final Block block = null;
	public FlatscreenTVCpuBlock(HirosdecorationmodModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("flatscreen_tv_cpu");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(FlatscreenTVCpuBlock.block, (int) (1));
		}
