...
public class BirchCoffeeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:birch_coffee_table")
	public static final Block block = null;
	public BirchCoffeeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("birch_coffee_table");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BirchCoffeeTableBlock.block, (int) (1));
		}
