...
public class WarpedDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:warped_dining_chair")
	public static final Block block = null;
	public WarpedDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("warped_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(WarpedDiningChairBlock.block, (int) (1));
		}
