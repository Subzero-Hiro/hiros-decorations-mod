...
public class AcaciaDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:acacia_dining_chair")
	public static final Block block = null;
	public AcaciaDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("acacia_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(AcaciaDiningChairBlock.block, (int) (1));
		}
