...
import net.hiro.decorationmod.itemgroup.ChairDecorationsItemGroup;
...
public class DarkOakDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:dark_oak_dining_chair")
	public static final Block block = null;
	public DarkOakDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(ChairDecorationsItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("dark_oak_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(DarkOakDiningChairBlock.block, (int) (1));
		}
