...
public class JungleDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:jungle_dining_chair")
	public static final Block block = null;
	public JungleDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("jungle_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(JungleDiningChairBlock.block, (int) (1));
		}
