...
public class SpruceDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:spruce_dining_chair")
	public static final Block block = null;
	public SpruceDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("spruce_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SpruceDiningChairBlock.block, (int) (1));
		}
