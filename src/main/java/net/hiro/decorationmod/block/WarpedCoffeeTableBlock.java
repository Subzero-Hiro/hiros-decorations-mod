...
public class WarpedCoffeeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:warped_coffee_table")
	public static final Block block = null;
	public WarpedCoffeeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("warped_coffee_table");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(WarpedCoffeeTableBlock.block, (int) (1));
		}
