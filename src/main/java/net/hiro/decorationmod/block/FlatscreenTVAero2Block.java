...
public class FlatscreenTVAero2Block extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:flatscreen_tv_aero_2")
	public static final Block block = null;
	public FlatscreenTVAero2Block(HirosdecorationmodModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("flatscreen_tv_aero_2");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(FlatscreenTVAero2Block.block, (int) (1));
		}
