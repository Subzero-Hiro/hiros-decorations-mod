...
public class DarkOakCoffeeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:dark_oak_coffee_table")
	public static final Block block = null;
	public DarkOakCoffeeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("dark_oak_coffee_table");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(DarkOakCoffeeTableBlock.block, (int) (1));
		}
