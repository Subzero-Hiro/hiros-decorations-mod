...
public class OakCoffeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:oak_coffe_table")
	public static final Block block = null;
	public OakCoffeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("oak_coffe_table");
		}
