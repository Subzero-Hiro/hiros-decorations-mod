...
public class BirchDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:birch_dining_chair")
	public static final Block block = null;
	public BirchDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("birch_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BirchDiningChairBlock.block, (int) (1));
		}
