...
public class CrimsonCoffeeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:crimson_coffee_table")
	public static final Block block = null;
	public CrimsonCoffeeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("crimson_coffee_table");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CrimsonCoffeeTableBlock.block, (int) (1));
		}
