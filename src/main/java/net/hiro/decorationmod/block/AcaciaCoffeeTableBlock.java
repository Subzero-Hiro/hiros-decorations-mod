...
public class AcaciaCoffeeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:acacia_coffee_table")
	public static final Block block = null;
	public AcaciaCoffeeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("acacia_coffee_table");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(AcaciaCoffeeTableBlock.block, (int) (1));
		}
