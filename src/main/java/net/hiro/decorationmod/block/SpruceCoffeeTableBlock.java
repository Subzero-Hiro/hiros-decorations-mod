...
public class SpruceCoffeeTableBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:spruce_coffee_table")
	public static final Block block = null;
	public SpruceCoffeeTableBlock(HirosdecorationmodModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("spruce_coffee_table");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SpruceCoffeeTableBlock.block, (int) (1));
		}
