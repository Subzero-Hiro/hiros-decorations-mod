...
public class CrimsonDiningChairBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:crimson_dining_chair")
	public static final Block block = null;
	public CrimsonDiningChairBlock(HirosdecorationmodModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("crimson_dining_chair");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CrimsonDiningChairBlock.block, (int) (1));
		}
