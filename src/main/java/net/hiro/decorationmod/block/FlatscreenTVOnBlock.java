...
import net.hiro.decorationmod.procedures.FlatscreenTVOffRightClickedProcedure;
...
public class FlatscreenTVOnBlock extends HirosdecorationmodModElements.ModElement {
	@ObjectHolder("hirosdecorationmod:flatscreen_tv_on")
	public static final Block block = null;
	public FlatscreenTVOnBlock(HirosdecorationmodModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 1).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("flatscreen_tv_on");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(FlatscreenTVBlock.block, (int) (1));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				FlatscreenTVOffRightClickedProcedure.executeProcedure($_dependencies);
			}
